...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal"
                                            data-application_id ="{{ $application->id }}" onclick="loadAmount(1)"
    ...
    <div id="activate" class="modal fade">
        <div class="modal-dialog modal-l">
            <div class="modal-content">
                <div class="modal-header  bg-light border-0">
                    <h6 class="modal-title text-dark">Pay Application Fee</h6>
                    <button type="button" class="btn-close btn-danger" data-bs-dismiss="modal"></button>
                </div>
                <form action="{{ route('application_fee-payment') }}" id="approve_form" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <input id="application_id" type="text" class="form-control" name="application_id"
                                    hidden>
                                <input id="payment_type" type="text" class="form-control" name="payment_type_id"
                                    hidden>
                            </div>
                        </div>
                    </div>
