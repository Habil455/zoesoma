                    ...
                    <div class="card">
                        <div class="card-header header-elements-sm-inline">
                            ...
                            <div class="header-elements">
                                ...
                                <a href="{{ route('users-role.index') }}" class="btn btn-secondary btn-xs px-4">
                            ...
                            <div class="tab-content tab-bordered" id="myTab3Content">
                                <div class="tab-pane fade @if (empty($id)) active show @endif"
                                    ...
                                    @foreach ($user as $users)
                                        <form action="{{ route('users-access.update', $users->id) }}" method="put"
                                            ...
                                            <div class="ibox-content p-0 px-3 pt-2">
                                                ...
                                                <div class="ibox-footer py-3">
                                                    <div class="row justify-content-end mr-1">
                                                        <button type="submit"
                                                            class="btn btn-sm btn-main col-4 px-5">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                    @endforeach
