                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-inline">
                                    ...
                                    <a class="list-icons-item text-primary" title="Edit" href="{{ route('users-access.edit', $user->id)}}" onclick="return confirm('Are you sure? you want to Edit')"><i class="ph-pen"></i></a>&nbsp&nbsp
